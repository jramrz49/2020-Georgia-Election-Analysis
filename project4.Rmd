...
```{r}
sort(GA$County)==sort(pop$County)
```
...
data$current_result[data$BidenVoteShare-data$TrumpVoteShare>0] = "Dem"
data$current_result[data$BidenVoteShare-data$TrumpVoteShare<0] = "Rep"
